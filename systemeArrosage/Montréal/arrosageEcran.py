...
# socConfigurationArrosage.bind((HostName, SendRec["ConfigurationEcranArrosage"].Port))
# 
...
# socRapportActivitesArrosage.bind((HostName, SendRec["RapportActivitesArrosage"].Port))
# def RapportActivitesArrosage():
#     global socRapportActivitesArrosage
#     global hostClient, HostName
# 
#     while True:
#         try:
...
#         except socket.error as msg:
#             if msg.errno ==  107:
#                 socRapportActivitesArrosage.close
#                 socRapportActivitesArrosage = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
#                 socRapportActivitesArrosage.bind((HostName, SendRec["RapportActivitesArrosage"].Port))
# 
# 
# socArrosageSystemeDataGicleurs = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
# socArrosageSystemeDataGicleurs.bind((HostName, SendRec["ArrosageEcranDataEquipement"].Port))
# def ArrosageSystemeDataGicleurs():
#     global socArrosageSystemeDataGicleurs, clientHost, clientPort
#     global HostName, EquipementInterface, gicleursStatut
#     data=b""
#     while True:
#         try:
...
#         except socket.error as msg:
#             if msg.errno ==  107:
#                 socArrosageSystemeDataGicleurs.close
#                 socArrosageSystemeDataGicleurs = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
#                 socArrosageSystemeDataGicleurs.bind((HostName, SendRec["ArrosageEcranDataEquipement"].Port))
# 
# 
...
#     global s
#     try:
#         print (" gicleur sys action  ", HOST,PORT, Requete)
...
#         print ("passe 5")
#         s.close()
#         print (" send to systeme arrosage ", HOST, PORT, Requete)
#     except socket.error as msg:
...
# 
# 
# def systemeArrosageAction(HOST, PORT, Requete):
#     try:
#         # recreate the socket and reconnect
#         s = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
#         s.connect((HOST, PORT))
#         print (" asdfasdfasdf", Requete)
#         data_string = pickle.dumps(Requete)
#         s.send(data_string)
#         s.close()
#     except Exception as e:
...
# 
# 
# def sendsystemeArrosageAction():
#     global HostName
#     while True:
#         systemeArrosageAction(SendRec["GicleursSystemeAction"].Ip, SendRec["GicleursSystemeAction"].Port, "getGicleursStatut")
#         sleep(1)
...
# t3.start()
# 
# t4 = threading.Thread(target=sendsystemeArrosageAction)
# t4.start()
